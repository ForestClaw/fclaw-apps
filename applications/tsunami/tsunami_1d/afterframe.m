...
unshift_x = @(x) h0*(x + t*sqrt(g/h0)) + b;
...
if (PlotType == 1)
    ...
    drawcontourlines(cv);
    colorbar;
    set(gca,'xlim',unshift_x(xl));
    set(gca,'ylim',[0,my*dy]);
    set(gcf,'position',[520,   531,  946,   267]);
...
if plot_surf
    ...
    ym = my*dy/2;
    plot3(shift_x(x_sgn1d),0*x_sgn1d + ym,q_sgn1d+1e-4,'r-','linewidth',2);
    set(gca,'xlim',xl);
    set(gca,'zlim',yl);
    set(gca,'xtick',xticks);
    daspect([10,50,0.05])
